...
def make_lmdb_from_imgs(data_path,
    ...
    Args:
        ...
        map_size (int | None): Map size for lmdb env. If None, use the
            estimated size from images. Default: None
        write_meta_info (bool): Whether to write meta_info.txt. Default: True.
    """
    ...
    txt_file = open(osp.join(lmdb_path, 'meta_info.txt'), 'w') if write_meta_info else None
    if write_meta_info:
        print(f'Writing meta_info.txt to: {osp.join(lmdb_path, "meta_info.txt")}')
