...
def create_lmdb_for_gopro():
    ...
    folder_path = r'datasets\train\GoPro\input_crops'
    # lmdb_path = 'datasets/GoPro/train/blur_crops.lmdb'
    lmdb_path = r'datasets\train\GoPro\input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys,write_meta_info=True)

    # # folder_path = './datasets/GoPro/train/sharp_crops'
    # folder_path = r'datasets\train\GoPro\target_crops'
    # # lmdb_path = './datasets/GoPro/train/sharp_crops.lmdb'
    # lmdb_path = r'datasets\train\GoPro\target_crops.lmdb'

    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # folder_path = r'./datasets/GoPro/test/target'
    # lmdb_path = r'./datasets/GoPro/test/target.lmdb'

    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # folder_path = './datasets/GoPro/test/input'
    # folder_path = r'datasets\test\GoPro\input_resized'
    # # lmdb_path = './datasets/GoPro/test/input.lmdb'
    # lmdb_path = r'datasets\test\GoPro\input_resized.lmdb'

    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # folder_path = './datasets/GoPro/test/input'
    # folder_path = r'datasets\test\GoPro\target'
    # # lmdb_path = './datasets/GoPro/test/input.lmdb'
    # lmdb_path = r'datasets\test\GoPro\target.lmdb'

    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # folder_path = './datasets/GoPro/test/input'
    # folder_path = r'datasets\results\GoPro_results\train_results'
    # # lmdb_path = './datasets/GoPro/test/input.lmdb'
    # lmdb_path = r'datasets\results\GoPro_results\train_results.lmdb'

    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # folder_path = './datasets/GoPro/test/input'
    # folder_path = r'datasets\results\GoPro_results\val_results'
    # # lmdb_path = './datasets/GoPro/test/input.lmdb'
    # lmdb_path = r'datasets\results\GoPro_results\val_results.lmdb'
